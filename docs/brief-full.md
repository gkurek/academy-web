...
| 2026-09-26 | 2.3    | Wystawy po przeglądzie 08b (K-82…K-90): trasa `/ikony/wystawy`, model `PermanentExhibition` + `AnnualExhibition` (`annual.json`), `News.venue` na wyjazdowe; przekierowania §3 na nowy adres; K-51 pozostaje w historii decyzji. Implementacja: `docs/plans/08b-review-fixes.md`. **Etap 8 implementacji zamknięty** (08 + 08b) — `docs/plan-claude-code.md` §2. |
